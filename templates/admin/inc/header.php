                        ...
                        <div class="">
                            <div class="d-flex align-items-center"
                                ...
                                <div class="d-flex flex-column align-items-start justify-content-center ms-3">
                                    ...
                                    <a href="#" class="text-gray-800 fs-7 fw-bold text-hover-primary">UĞUR IŞIK</a>
                                </div>
                            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="#"
                                                class="fw-semibold text-muted text-hover-primary fs-7">ugur.isik@defsu.com.tr</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item px-5">
                                    <a href="account/overview.html" class="menu-link px-5">Profil Bilgilerim</a>
                                </div>

                                <div class="menu-item px-5">
                                    <a href="apps/projects/list.html" class="menu-link px-5">
                                        <span class="menu-text">Kullanıcı Loglarım</span>
                                        <span class="menu-badge">
                                            <span class="badge badge-light-danger  fw-bold fs-7">1258</span>
                                        </span>
                                    </a>
                                </div>
                                ...
                                <div class="menu-item px-5 my-1">
                                    <a href="account/settings.html" class="menu-link px-5">Tercihlerim</a>
                                </div>
